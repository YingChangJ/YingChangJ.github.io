...
button.addEventListener("click", function () {
  ...
  if (
    ...
    re.forEach((item) => {
      ...
      const localDateTime = new Astronomy.AstroTime(item - 2451545.0);
      const localDateTime1 = localDateTime.date;
      li.textContent =
        localDateTime1.getUTCFullYear().toString() +
        "-" +
        (localDateTime1.getUTCMonth() + 1).toString() +
        "-" +
        localDateTime1.getUTCDate().toString() +
        " " +
        localDateTime1.getUTCHours().toString() +
        ":" +
        localDateTime1.getUTCMinutes().toString() +
        ":" +
        localDateTime1.getUTCSeconds().toString();
